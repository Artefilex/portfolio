  ...
  return (
    <div data-aos="zoom-in-down" className="skillcard-container flex">
      ...
      <div data-aos="zoom-out-up" className="skillcard-context flex">
        <p data-aos-duration="1000" data-aos="zoom-in-down" >I'm thrilled to share my 2.5-year learning journey with you! </p>
        <ul className="flex">
          <li className="flex">
            <div className="info-icon" data-aos-duration="2000" data-aos="zoom-in-down">
              <BiLogoGithub className="icon github" /> <span>24</span>
            </div>
            <p> repositories on GitHub</p>
          </li>
          <li className="flex">
            <div className="info-icon" data-aos-duration="4000" data-aos="zoom-in-down">
              <BiLogoJavascript className="icon javascript" /> <span>7</span>
            </div>
            <p> HTML CSS JS Projects</p>
          </li>
          <li className="flex">
            <div className="info-icon" data-aos-duration="5000" data-aos="zoom-in-down">
              <FaReact className="icon react" /> <span>8</span>
            </div>
            <p>React Projects</p>
          </li>
          <li className="flex">
            <div className="info-icon" data-aos-duration="6000" data-aos="zoom-in-down">
